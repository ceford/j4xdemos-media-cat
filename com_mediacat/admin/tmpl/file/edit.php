		...
		<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'file')); ?>
			...
			<div class="row">
				<div class="col-12 col-lg-6">
					<p><?php echo Text::_('COM_MEDIACAT_FIELD_FILE_EXTENSIONS_LABEL'); ?>
					<?php echo str_replace(',', ', ', $params->get('file_upload_extensions')); ?>.
					<br />
					<?php echo Text::_('COM_MEDIACAT_FIELD_FILE_MAXIMUM_SIZE_LABEL'); ?>
					...
					<div class="control-group">
						<div class="control-label">
							<label id="jform_uploadfile-lbl" for="jform_uploadfile">
								<?php echo Text::_('COM_MEDIACAT_FILE_UPLOAD_LABEL'); ?>
							</label>
						</div>
						<div class="controls">
					...
					<div class="control-group">
						<div class="control-label">
							...
							<?php echo Text::_('COM_MEDIACAT_FILE_UPLOAD_SHORT_DESCRIPTION_LABEL'); ?>
							</label>
						</div>
						<div class="controls">
							<?php
					...
					<div class="control-group">
						<div class="control-label">
							...
							<?php echo Text::_('COM_MEDIACAT_FILE_UPLOAD_LONG_DESCRIPTION_LABEL'); ?>
							</label>
						</div>
						<div class="controls">
							...
							<div id="jform[caption]-desc">
								<small class="form-text text-muted">
							<?php echo Text::_('COM_MEDIACAT_FILE_UPLOAD_LONG_DESCRIPTION_DESC'); ?>
								</small>
							</div>
						</div>
					</div>
